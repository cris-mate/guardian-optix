...
const Header: React.FC<HeaderProps> = ({ onRefresh, onAddShift, isLoading, isManager }) => (
  <HStack justify="space-between" align="center" flexWrap="wrap" gap={4}>
    ...
    <HStack gap={2}>
      ...
      {isManager && (
        <Button colorPalette="blue" size="sm" onClick={onAddShift}>
  ...
  const statItems = [
    {
      ...
      subtext: `${stats.scheduledShifts} scheduled`,
      icon: LuCalendarDays,
      color: 'blue',
    },
    {
      ...
      subtext: `${stats.completedShifts} completed`,
      icon: LuClock,
      color: stats.inProgressShifts > 0 ? 'green' : 'gray',
    },
    {
    ...
    },
    {
      ...
      subtext: stats.cancelledShifts > 0 ? `${stats.cancelledShifts} cancelled` : 'All shifts covered',
      icon: LuCircleCheck,
      color: stats.coveragePercentage >= 90 ? 'green' : stats.coveragePercentage >= 70 ? 'orange' : 'red',
    },
  ];
